...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		List<Float> perList = new ArrayList<Float>(Arrays.asList(20F, 30F, 15F,
				35F));
		/**名字数据*/
		List<String> nameList = new ArrayList<String>(Arrays.asList("桌子","铅笔","钢琴","水杯"));
		/**RGB颜色数据*/
		List<Integer> rgbList = new ArrayList<Integer>(Arrays.asList(
				0xFF444444, 0xFFCCCCCC, 0xFFFF0000, 0xFF0000FF));
		pieChartView.setData(perList,nameList, rgbList);
